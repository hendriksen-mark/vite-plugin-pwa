...
function _generateBundle(ctx, bundle) {
  ...
  if ((options.injectRegister === "script" || options.injectRegister === "script-defer") && !existsSync(resolve3(viteConfig.publicDir, options.FILE_SW_REGISTER))) {
...
async function createDevRegisterSW(options, viteConfig) {
  if (options.injectRegister === "script" || options.injectRegister === "script-defer") {
    ...
    const registerSW = resolve4(devDist, options.FILE_SW_REGISTER);
